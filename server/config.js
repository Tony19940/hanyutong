...
export const config = {
  ...
  referralRewardDays: readInt(process.env.REFERRAL_REWARD_DAYS, 3),
  dailyStudyGoal: readInt(process.env.DAILY_STUDY_GOAL, 8),
  freeQuizQuestionsPerDay: readInt(process.env.FREE_QUIZ_QUESTIONS_PER_DAY, 2),
  freeDialogueRoundsPerDay: readInt(process.env.FREE_DIALOGUE_ROUNDS_PER_DAY, 1),
  inviteLeaderboardLimit: readInt(process.env.INVITE_LEADERBOARD_LIMIT, 5),
